...
export const movieData: ScreeningType = {
  ...
  screeningId: "34213",
  screenings: [
    new Date('2023-05-10T09:30:00.000Z').toISOString(), 
    new Date('2023-05-10T14:45:00.000Z').toISOString(), 
    new Date('2023-05-10T16:15:00.000Z').toISOString(), 
    new Date('2023-05-11T10:00:00.000Z').toISOString(), 
    new Date('2023-05-11T14:30:00.000Z').toISOString(), 
    new Date('2023-05-11T11:30:00.000Z').toISOString(), 
    new Date('2023-05-12T13:45:00.000Z').toISOString(),
  ],
  rating: 5,
  poster:
...
export const movieDataArray: ScreeningType[] = [
  {
    ...
    screeningId: "12255",
    screenings: [
      new Date('2023-05-18T09:30:00.000Z').toISOString(), 
      new Date('2023-05-18T14:45:00.000Z').toISOString(), 
      new Date('2023-05-18T16:15:00.000Z').toISOString(), 
      new Date('2023-05-19T10:00:00.000Z').toISOString(), 
      new Date('2023-05-19T14:30:00.000Z').toISOString(), 
      new Date('2023-05-19T11:30:00.000Z').toISOString(), 
      new Date('2023-05-12T13:45:00.000Z').toISOString(),
    ],
    rating: 3,
    poster:
